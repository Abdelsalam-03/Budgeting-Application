...
public class BudgetController {
    ...
    public ControllerResult<Budget> saveBudget(String category, double amount, YearMonth period) {
        try {
    ...
    public ControllerResult<Budget> updateBudget(int id, String category, double amount, YearMonth period) {
        try {
    ...
    public List<String>      getCategories()                  { return BudgetService.getCategories(); }
