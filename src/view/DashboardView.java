...
public class DashboardView {
     ...
     */
    public DashboardView(Runnable onGoToBudgets) {
    ...
    private HBox txRow(Transaction t) {
        ...
        VBox info = new VBox(2,
                lbl(t.getDescription(), 13, FontWeight.BOLD, WHITE),
                lbl(t.getDate() + "  •  " + t.getCategory(), 11, FontWeight.NORMAL, SUB));
        ...
        row.getChildren().addAll(
                ...
                info, sp,
                lbl((isIncome ? "+" : "-") + "$" + String.format("%.2f", t.getAmount()),
    ...
    private HBox warningRow(Budget b) {
        ...
        VBox info = new VBox(2,
                ...
                lbl(String.format("Spent $%.2f of $%.2f", b.getSpent(), b.getAmount()),
